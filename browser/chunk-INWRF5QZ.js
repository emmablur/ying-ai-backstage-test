...
var AuthRoutingModule = class _AuthRoutingModule {
  ...
  static \u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ imports: [RouterModule.forChild([
    {
      path: "error",
      loadChildren: () => import("./chunk-DJ6MO3FQ.js").then((m) => m.ErrorModule)
    },
    {
      path: "access",
      loadChildren: () => import("./chunk-W2NPWEQO.js").then((m) => m.AccessModule)
    },
    {
      path: "login",
      loadChildren: () => import("./chunk-HMCRSQRF.js").then((m) => m.LoginModule)
    },
...
//# sourceMappingURL=chunk-INWRF5QZ.js.map
